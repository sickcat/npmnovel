...
export default {
     ...
     */
    getCategory() {
        return Vue.http.get('/api/category');
    },
     ...
     */
    getCategoryDetail() {
        return Vue.http.get('/api/category/detail');
    ...
    getMixChapters(bookId) {
        //get chapter list
        return Vue.http.get('/api/chapters/' + bookId)
    },
     ...
     */
    getUpdate(bookList){
        return Vue.http.get('/api/book?view=updated&id=' + bookList.toString());
    }
